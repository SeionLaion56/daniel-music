...
const SPACING = { compact: 'py-10', normal: 'py-20', spacious: 'py-32' };

export function HeroSection({ hero, isAdmin, onUpdate, spacing = 'normal' }) {
  return (
    <section className={`relative min-h-[70vh] flex items-center justify-center px-6 ${SPACING[spacing]}`}>
        ...
        {(hero.image || isAdmin) && (
          <div className="mb-10">
            <EditableImage
              ...
              placeholder={
                <div className="w-full h-64 rounded-2xl bg-white/5 border-2 border-dashed border-white/20 flex items-center justify-center text-white/40 text-sm">
